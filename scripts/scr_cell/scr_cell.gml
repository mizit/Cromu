...
//пока что у неё три поля(уже пять)
function Cell(_x, _y) constructor
{
	...
	attraction = -100000; //уровень привлекательности
	step = 0;	//шаг игры, вспомогательная переменная необходимая для отслеживания необходимости обновления клетки
}